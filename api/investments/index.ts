...
interface HoldingRow {
    ...
    option_contract: string | null; // JSON string
    fixed_income: string | null; // JSON string
...
const httpTrigger: AzureFunction = async function (
    ...
    try {
        ...
        const holdingsResult = await executeQuery<HoldingRow>(holdingsQuery, params);
        ...
        const transactionsResult = await executeQuery<TransactionRow>(transactionsQuery, params);
