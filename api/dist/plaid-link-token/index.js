...
const httpTrigger = async function (context, req) {
    ...
    try {
        ...
        const clientResult = await (0, database_1.executeQuery)(`SELECT client_id, first_name, last_name, email, phone_number, plaid_user_id
             FROM clients
        ...
        if (!plaidUserId) {
            ...
            try {
                ...
                const userResponse = await (0, plaid_client_1.createPlaidUser)(String(client.client_id));
                ...
                await (0, database_1.executeQuery)(`UPDATE clients SET plaid_user_id = @plaidUserId WHERE client_id = @clientId`, { plaidUserId, clientId });
